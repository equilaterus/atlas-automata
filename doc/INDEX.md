...
This index routes agents and developers to detailed specifications. `AGENTS.md` contains only rules that must be loaded for every task.

| Document | Load when you need |
| --- | --- |
...
When adding, renaming, moving, or materially repurposing a specification page, update this index in the same change.
